...
impl Niri {
    pub fn new(
        ...
        let cursor_scale_tracker = CursorScaleTracker::new(animation_clock.clone(), config_.cursor.shake.clone());
        let cursor_manager =
    ...
    pub fn advance_animations(&mut self) {
        ...
        if self.cursor_scale_tracker.advance_animations(&mut self.cursor_manager) {
            // FIXME: can be more grandular
            self.queue_redraw_all();
        }
